...
static const struct Class object [] = {
    { {object + 1}, "Object", object, sizeof(struct Object), Object_ctor, Object_dtor, Object_differ, Object_puto }, 
    { {object + 1}, "Class", object, sizeof(struct Class), Class_ctor, Class_dtor, Object_differ, Object_puto}
};
...
static void * Class_dtor (void * _self)
{
    ...
    fprintf(stdout, "%s: cannot destory class\n", self -> name);
    return 0;
}
